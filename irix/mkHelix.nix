...
# @input args: The module arguments, nothing currently.
# @input home.user: Who need me? This is passed by mkHomeManager.
args: { user }:  # <- Module arguments
    ...
    programs.helix = {
      ...
      settings = {
        ...
        keys = {
          ...
          normal.g = {
            R = [ "goto_prev_function_name" "goto_reference" ];
            ";" = "goto_word_reference";
          };
          ...
          normal."'" = {
            ...
            h = [ ":toggle file-picker.hidden" ":toggle file-picker.git-ignore" ];
