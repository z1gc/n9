...

{
  ...
  # networking.interfaces.br-iptv.useDHCP = lib.mkDefault true;
  # networking.interfaces.br-lan.useDHCP = lib.mkDefault true;
  ...
  # networking.interfaces.enp5s0f1np1.101.useDHCP = lib.mkDefault true;
